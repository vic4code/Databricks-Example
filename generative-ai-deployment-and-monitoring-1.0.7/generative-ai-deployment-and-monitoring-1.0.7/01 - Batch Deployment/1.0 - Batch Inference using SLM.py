...
# MAGIC
# MAGIC **📌 Promoting models vs. code**: We track the path from development to production via the Model Registry. That is why, we are *promoting models* towards production, rather than promoting code.
# MAGIC
